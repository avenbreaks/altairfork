...
function CheckGeth()
{
	...
	echo Peers: `geth attach --exec "admin.peers" data/execution/$1/geth.ipc | grep "remoteAddress" | grep -e $my_ip -e "86.109.14.237"`
...
{
	Log Importing Account 0x406d76f95a450531e82ad49cf1885d1929cbb711
	echo "231196" > data/execution/geth_password.txt
	echo "57a3da09ab8b9cf20a1d7d8909e47196b047cb20605b448da61d7de16d5f8ff4" > data/execution/account_geth_privateKey
...
function RunBeacon() {
	...
	nohup lodestar beacon \
	  --suggestedFeeRecipient "0x406d76f95a450531e82ad49cf1885d1929cbb711" \
...
function RunBeacon_Prysm() {
	...
	nohup clients/beacon-chain \
	  --min-sync-peers=$i \
	  --suggested-fee-recipient "0x406d76f95a450531e82ad49cf1885d1929cbb711" \
...
function RunBeacon_Lighthouse() {
	...
	nohup clients/lighthouse beacon \
		--eth1 \
		--http \
		...
		--graffiti "Gitshock Block Explorer" \
		--http-allow-origin * \
		--http-port $((5052 + $1)) \
		--port $((9000 + $1)) \
		--suggested-fee-recipient "0x406d76f95a450531e82ad49cf1885d1929cbb711" \
...
function RunStaker {
	...
	echo {\"keys\":$(cat `ls -rt $folder/deposit_data* | tail -n 1`), \"address\":\"0x406d76f95a450531e82ad49cf1885d1929cbb711\", \"privateKey\": \"0x57a3da09ab8b9cf20a1d7d8909e47196b047cb20605b448da61d7de16d5f8ff4\"} > $folder/payload.txt
